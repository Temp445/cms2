...
const Clients: React.FC = () => {
  ...
  return (
    <div className="px-5  md:mt-10  z-0 container mx-auto" id="client">
        <h1 className="text-center mx-auto text-xl md:text-2xl font-bold md:mb-8  text-gray-900 border max-w-fit p-2 rounded relative">
 <div className='hidden w-14   h-1 inset-0 lg:flex  absolute bg-black  rounded-b mx-auto'></div>
        {/* <div className='hidden w-14 h-1   lg:flex  absolute bg-black  rounded-t  left-24 bottom-0'></div> */}
