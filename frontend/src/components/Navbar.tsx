      ...
      <nav className="flex items-center justify-between md:pt-5 lg:pb-10 px-4 md:px-0 lg:px-6 relative">
        <div className="md:flex items-center hidden ">
          <Link href="/" className="text-2xl md:text-xl lg:text-2xl xl:text-3xl font-bold text-gray-800 flex gap-1">
            ...
            />
            <span className="mt-2 text-white">ACE CMS </span>
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-2">
          <Link
            href="#features"
            className="flex items-center text-white hover:text-white text-base font-semibold relative px-4 py-2 rounded-full transition-all duration-300 ease-in-out hover:bg-teal-600"
          >
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link
            href="/signin"
            className="bg-green-700 hover:bg-green-600 text-white px-4 py-1 md:px-2 lg:px-6 xl:py-2 rounded-md font-medium transition"
          >
            Sign In
          </Link>
        </div>
