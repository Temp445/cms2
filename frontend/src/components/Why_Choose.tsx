      ...
      <div className="container mx-auto px-2 md:px-4">
        <div className="flex flex-col xl:flex-row items-center gap-8 xl:gap-16 container">
          <div className="w-full md:w-8/12  xl:w-5/12 relative">
            ...
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-teal-100 rounded-full opacity-70 z-0"></div>
          </div>
          
        
          <div className="w-full xl:w-7/12 space-y-6  border border-gray-200  sm:border-0 pt-5 pb-10 px-2 lg:px-12 xl:px-2 rounded">
            <div className="inline-block bg-blue-50 text-teal-600 px-4 py-1 rounded-full font-medium">
              Why Choose Us?
            </div>
            
            <h2 className="text-2xl md:3xl 2xl:text-4xl font-bold text-gray-800 leading-tight">
               ACE CMS – Smart <span className='text-teal-600 mr-2'>Calibration Management</span> <br className='hidden lg:block' />Made Simple
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
              {[
                ...
                <div 
                  key={index} 
                  className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 hover:bg-teal-100 border border-teal-100"
                >
        ...
        <div className='w-[130px] md:w-36'>
              <Link href="#features" className=" text-sm  mt-6 bg-black text-white font-medium py-2 px-2 gap-3 md:py-2 md:px-3 rounded shadow-md transition-colors duration-300  flex items-center md:gap-5">
              Learn More
               <MoveRight size={20}/>
            </Link>
        </div>
