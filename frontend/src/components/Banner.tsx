...
const Banner = () => {
  ...
  return (
         <div className='bg-radial-[at_50%_200%] from-teal-600   to-gray-900 to-60% mt-8 md:mt-10'>
      ...
      <div className="lg:w-1/2 text-center lg:text-left space-y-4">
        <h1 className=" text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold  lg:block   text-white ">
          Access Anytime via <span className='flex text-center lg:text-left lg:justify-start mx-auto justify-center  '><span className='bg-clip-text text-transparent bg-[#05B860]  font-bold'>Android Devices</span>  <Image src={icon} alt="icon" className='w-6 h-6 md:w-10 mt-2 md:h-10 ml-2' /></span>
        </h1>
