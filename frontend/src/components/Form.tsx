...
const Form: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const emailInput = (form.current.elements.namedItem("email") as HTMLInputElement).value;
    ...
    <div id="contact">
      <div className="mt-5 md:px-2">
        <div className="flex flex-col md:flex-row p-4 py-10  rounded-lg  md:py-10 max-w-6xl mx-auto sm:mt-20 mb-20 justify-center">
          <div className="md:w-7/12 rounded md:rounded-none md:rounded-l-sm md:border-gray-800 border p-5 md:p-10">
            <h2 className="text-xl md:text-3xl font-semibold text-gray-800 mb-6">
              Get in touch and  <strong className="text-teal-600">schedule your demo now!</strong>
            </h2>
            <form ref={form} onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-black text-white py-1 px-3 md:px-4 md:py-2 rounded hover:bg-green-500 flex gap-3 md:text-lg"
              >
        ...
        <div className="mt-20 md:mt-0 md:w-5/12 bg-gray-900 text-white border border-e-gray-800 border-y-gray-800 border-l-gray-800 md:border-l-0 rounded md:rounded-none md:rounded-r-sm" >
