      ...
      <div className="w-full  flex  justify-center container mx-auto p-4 ">
        <div className="relative w-full max-w-5xl">
          <Image
            src={CMS}
            alt="CMS"
            className="w-full md:h-[450px] rounded-xl shadow-lg object-cover border border-black"
          />
          <button
            onClick={handleDemoClick}
            className="absolute inset-0 m-auto flex items-center justify-center gap-1 md:gap-2 px-3 py-2 md:px-6 md:py-3 bg-black text-white rounded-full  transition-transform hover:scale-105 shadow-lg w-max h-max animate-pulse"
